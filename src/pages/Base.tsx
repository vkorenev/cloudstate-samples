...
import { IconButton, Typography, CssBaseline, AppBar, Drawer, Toolbar, Divider, List, ListItem, ListItemIcon, ListItemText, GridList, GridListTile, Paper } from '@material-ui/core';
...
class Base extends React.Component<Props & WithStyles<typeof styles>, State> {
  ...
  handelOnUserAdd = (user: User) => {
    this.props.store.userStore.addUser(user);
    ...
    return (    
        ...
        <main className={classes.content}>
          ...
          <GridList spacing={1} style={ {height: "100%"} } className={classes.gridList} cols={2}>
            {this.props.store.userStore.stream.map(user => (
